...
@Component({
  selector: 'app-explorer-lists',
  templateUrl: './explorer-lists.component.html',
  styleUrls: ['./explorer-lists.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ExplorerListsComponent implements OnInit {
  ...
  toggleclass(myclass) {
    const el = this.elRef.nativeElement.querySelector('.' + myclass);
    switch (myclass) {
      ...
      case 'antennas-container': {
        this.hideAntennas = !this.hideAntennas;
        break;
      }
      case 'cells-container': {
